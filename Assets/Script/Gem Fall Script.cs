...
{
    // Array to hold multiple prefabs
    ...
    void Update()
    {
        ...
        {
            SpawnRandomObject(); // Call new method to spawn random object
            timer = 0; 
        }
    }
    ...
    {
        float randomX = Random.Range(-8f, 8f); // Randomize X position
        ...
        Instantiate(gameObjects[randomIndex], spawnPosition, Quaternion.identity); 
    }
}
